import { Question, NormalType, PersonalityType } from './types';
...
// Using single quotes for all string values to avoid inner quote escaping issues
export const TYPE_LIBRARY: Record<string, PersonalityType> = {
  ...
  'Dior-s': { code: 'Dior-s', cn: '屌丝', intro: '等着我屌丝逆袭。', desc: '恭喜！您并非屌丝，您是犬儒主义先贤第欧根尼失散多年的精神传人。Dior-s人格，是对当代消费主义陷阱和成功学PUA最彻底的蔑视。他们不是\u201c不求上进\u201d，而是早已看穿一切\u201c上进\u201d的尽头不过是更高级的牢房。屌丝有着大智慧。当别人在追逐风口，被时代的巨浪拍得七荤八素时，Dior-s早已在自己的精神木桶里晒着太阳，达到了\u201c人桶合一\u201d的至高境界。他们信奉的不是空话，是经过亿万次实践检验的物理法则与生物本能：一、躺着比站着舒服；二、饭点到了就得干饭。' },
